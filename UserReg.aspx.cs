...
namespace MultiUserApplication
{
    public partial class UserReg : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string ins = "insert into User_Reg values(" + regid + ",'" + TextBox1.Text + "','" + TextBox2.Text + "')";
            int i = clsobj.fn_execute_nonquery(ins);
            if (i == 1)
            {
                string inslog = "insert into Login_tbl values(" + regid + ",'" + TextBox3.Text + "','" + TextBox4.Text + "','user','active')";
